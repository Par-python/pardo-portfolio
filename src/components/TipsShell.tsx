  ...
  return (
    <>
      <button
        ...
        title="Show tips"
        className="fixed bottom-3 right-3 sm:top-3 sm:right-auto sm:left-3 sm:bottom-auto z-40 size-[36px] sm:size-[40px] bg-[#c0c0c0] win-frame-outside flex items-center justify-center cursor-pointer hover:bg-[#d4d4d4]"
      >
